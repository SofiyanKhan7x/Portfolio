const Home = () => {
  return (
    <div className="flex items-center justify-end h-full w-full px-4 sm:px-8 md:px-16 py-10">
      <div className="max-w-3xl">
        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-center sm:text-justify">
