const Home = () => {
  return (
    <div className="flex items-center justify-end h-full w-full px-4 sm:px-10 md:px-20 max-sm:justify-center">
      <p className="text-base sm:text-lg leading-relaxed max-w-xl text-center sm:text-left">
        ...
        am passionate about building efficient and scalable backend systems. My
        expertise also includes working with RDBMS for effective database
