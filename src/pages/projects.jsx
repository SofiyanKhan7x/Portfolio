...
//   return (
//     <div className="flex flex-col lg:flex-row w-full h-full p-4 sm:p-6 space-y-6 lg:space-y-0 lg:space-x-6">
//       {/* Project List */}
...
//         </h2>
//         <p className="mb-4 text-base sm:text-lg leading-relaxed text-justify sm:text-left">
...
const Projects = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row-reverse w-full h-full p-4 sm:p-6">
      {/* Project List */}
      <div className="w-full lg:w-64 flex flex-col items-center text-center lg:items-start lg:text-left space-y-0 mb-6 lg:mb-0 lg:ml-10">
        {projectList.map((project, index) => (
          <div
            key={index}
            onClick={() => setSelectedProject(project)}
